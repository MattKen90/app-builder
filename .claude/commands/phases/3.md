...
**Mode-Aware**: Reads `.mode` file to determine paths and feature prefixes.
...
4. If missing → "Phase 2 not complete. Run /phases/2 first."
5. If exists → Proceed to DDD
```
...
│   Understand  Document  Breakdown  Implement  Review │
│                                                      │
│   Repeat for each feature in ROADMAP.md             │
└─────────────────────────────────────────────────────┘
```
...
State is tracked in:
- **Greenfield**: `.state/project.json`
- **Enhancer**: `.enhancer/state/project.json`
...
🔄 F-PAY - Billing Infrastructure (in progress - Step 3)
⏳ F2 - Dashboard (pending)
...
```
🔄 Resuming: F-PAY - Billing Infrastructure
...
```
⏭️ Next Feature: F2 - Dashboard

Dependencies satisfied: F1 ✓, F-PAY ✓
...
⚠️ Regression in existing functionality
- Test: [test name]
- Error: [error message]
...
```
🎉 Phase 3 Complete: All Features Built!

Features Implemented:
✅ F1 - User Authentication
✅ F-PAY - Billing Infrastructure
✅ F2 - Dashboard
✅ F3 - Data Export
✅ F4 - Settings
