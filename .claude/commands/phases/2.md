...
**Mode-Aware**: Reads `.state.json` to determine input/output paths.
...
- [ ] Human has approved
- [ ] `.claude/rules/app/llm-context.md` updated

---

## Final Step: Update LLM Context

Update `.claude/rules/app/llm-context.md` with architecture info:

```
## STATE
mode:greenfield|target:./app|phase:2|feat:0/N

## ARCH
stack:[framework+lang]|db:[database]|auth:[method]|pay:stripe|deploy:[platform]

## ROADMAP
p1:[F1,FPAY]|p2:[F2,F3]|p3:[F4]|curr:ready|next:F1

## DEPS
[Update dependency graph]
```

Keep it token-dense. Under 50 lines total.
